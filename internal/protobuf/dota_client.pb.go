...
// discarding unused import dota_gcmessages_client_fantasy "dota_gcmessages_client_fantasy.pb"
...
type CMsgDOTATournament_Team struct {
	...
	NodeOrState      *ETournamentTeamState `protobuf:"varint,8,opt,name=node_or_state,enum=ETournamentTeamState,def=0" json:"node_or_state,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
